(() => {
  var h,
    ...
    R = function (t) {
      document.visibilityState === "hidden" &&
        C > -1 &&
        ((C = t.type === "visibilitychange" ? t.timeStamp : 0), ye());
    },
    K = function () {
                  ...
                  f.forEach(function (u) {
                    if (!u.hadRecentInput) {
                      var g = c[0],
                        w = c[c.length - 1];
                      a &&
                      u.startTime - w.startTime < 1e3 &&
                      u.startTime - g.startTime < 5e3
                        ? ((a += u.value), c.push(u))
                        : ((a = u.value), (c = [u]));
                    }
                  }),
    ...
    Se = new Date(),
    ne = function (t, e) {
      h || ((h = e), (F = t), (J = new Date()), ie(removeEventListener), re());
    },
    re = function () {
      if (F >= 0 && F < J - Se) {
        var t = {
        ...
        P(function () {
          ...
          var i,
            ...
            r = function (a) {
              ...
              var c,
                s = ((c = Math.min(p.length - 1, Math.floor(le() / 50))), p[c]);
              s &&
                s.latency !== n.value &&
                ((n.value = s.latency), (n.entries = s.entries), i());
            },
            o = L("event", r, { durationThreshold: e.durationThreshold || 40 });
          (i = v(t, n, de, e.reportAllChanges)),
            o &&
              (o.observe({ type: "first-input", buffered: !0 }),
              A(function () {
                r(o.takeRecords()),
                  n.value < 0 && le() > 0 && ((n.value = 0), (n.entries = [])),
                  i(!0);
              }),
              y(function () {
                (p = []),
        ...
        (n = n || {}),
          P(function () {
            var r,
              ...
              c = function (f) {
                ...
                u &&
                  ...
                  ((a.value = Math.max(u.startTime - x(), 0)),
                  (a.entries = [u]),
                  r());
              },
            ...
            if (s) {
              ...
              var l = z(function () {
                U[a.id] ||
                  (c(s.takeRecords()), s.disconnect(), (U[a.id] = !0), r(!0));
              });
          ...
          if (n.entries.length) {
            ...
            if (r) {
              var o = r.activationStart || 0,
                ...
                c =
                  a.url &&
                  performance.getEntriesByType("resource").filter(function (w) {
                    return w.name === a.url;
                  })[0],
      ...
      Ie(function () {
        ...
        if (r) {
          ...
          (i.value = Math.max(o - x(), 0)),
            ...
            n(!0),
            y(function () {
              (i = m("TTFB", 0)), (n = v(t, i, he, e.reportAllChanges))(!0);
            });
        }
      });
    },
  ...
  function k(t, e) {
    return {
      source: "framer.site",
      timestamp: Date.now(),
      data: { type: "track", uuid: Me(), event: t, ...e },
    };
  }
  function xe() {
    let t = new Set(),
  ...
  (function () {
    ...
    xe(), Ae(), Re(), j({ initialReferrer: (t && document.referrer) || null });
  })();
})();
